...
#include "rz-ngml-annotation-filter.h"
...
NGML_Annotation_Filter::NGML_Annotation_Filter(QString raw_text)
{
 parse(raw_text);
}

void NGML_Annotation_Filter::parse(QString raw_text)
{
...
bool NGML_Annotation_Filter::check(QString& key)
{
...
void NGML_Annotation_Filter::parse(QString raw_text, QStringList& target)
{
 QRegExp rx("(\\s*/\\s*)|$");
