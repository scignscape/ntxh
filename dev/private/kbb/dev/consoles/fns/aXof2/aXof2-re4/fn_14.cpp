...
void _f_X14_4_(u1 ac_pattern, u4& retv,  QVector<n8>& args, minimal_fn_s0_re4_type fn,
  minimal_fn_s1_re4_type sfn, void** _this) // # 11
{
 switch(ac_pattern)
 {
 ...
 {u1 a1=*(u1*)args[0];u4 a2=*(u4*)args[1];
  auto _sfn = (u4(_min_::*)(u1,u4))(sfn);
  if(_this) retv=((_min_*)*_this->*_sfn)(a1,a2);
  else retv=((u4(*)(u1,u4))fn)(a1,a2);
 } break;

 case 255: // 2 args, higher-number pretype first
 {u4 a1=*(u4*)args[0];u1 a2=*(u1*)args[1];
  auto _sfn = (u4(_min_::*)(u4,u1))(sfn);
  if(_this) retv=((_min_*)*_this->*_sfn)(a1,a2);
  else retv=((u4(*)(u4,u1))fn)(a1,a2);
 } break;
