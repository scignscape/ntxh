...
void _f_X3_1_(u1 ac, u1& retv,  QVector<n8>& args, minimal_fn_s0_re1_type fn,
  minimal_fn_s1_re1_type sfn, void** _this)
{
 ...
 case 1:
  {QString a1=*(QString*)args[0];
   auto _sfn = (u1(_min_::*)(QString))(sfn);
   if(_this) retv=((_min_*)*_this->*_sfn)(a1);
   else retv=((u1(*)(QString))fn)(a1);
  } break;

 case 2:
  {QString a1=*(QString*)args[0];QString a2=*(QString*)args[1];
   auto _sfn = (u1(_min_::*)(QString,QString))(sfn);
   if(_this) retv=((_min_*)*_this->*_sfn)(a1,a2);
   else retv=((u1(*)(QString,QString))fn)(a1,a2);
  } break;
 ...
 case 7:
  {QString a1=*(QString*)args[0];QString a2=*(QString*)args[1];QString a3=*(QString*)args[2];QString a4=*(QString*)args[3];QString a5=*(QString*)args[4];QString a6=*(QString*)args[5];QString a7=*(QString*)args[6];
   auto _sfn = (u1(_min_::*)(QString,QString,QString,QString,QString,QString,QString))(sfn);
   if(_this) retv=((_min_*)*_this->*_sfn)(a1,a2,a3,a4,a5,a6,a7);
   else retv=((u1(*)(QString,QString,QString,QString,QString,QString,QString))fn)(a1,a2,a3,a4,a5,a6,a7);
  } break;
 ...
 case 8:
  {QString a1=*(QString*)args[0];QString a2=*(QString*)args[1];QString a3=*(QString*)args[2];QString a4=*(QString*)args[3];QString a5=*(QString*)args[4];QString a6=*(QString*)args[5];QString a7=*(QString*)args[6];QString a8=*(QString*)args[7];
   auto _sfn = (u1(_min_::*)(QString,QString,QString,QString,QString,QString,QString,QString))(sfn);
   if(_this) retv=((_min_*)*_this->*_sfn)(a1,a2,a3,a4,a5,a6,a7,a8);
   else retv=((u1(*)(QString,QString,QString,QString,QString,QString,QString,QString))fn)(a1,a2,a3,a4,a5,a6,a7,a8);
  } break;
