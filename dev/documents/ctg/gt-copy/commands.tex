...
{#3}{\ifx\ttmp\@empty#4\else#1\fi}{\sannot{#5}}}
\makeatother
...
\newcommand{\discoursemarkup}[1]{}
\newcommand{\discoursemarkupinline}[1]{#1}

\newcommand{\femph}[1]{\textbf{#1}}

%%%% Taken from https://www.pinguinorodriguez.cl/blog/typesetting-tobi/ 

\newcommand{\ToBIhigh}{\textsc{h}}
\newcommand{\ToBIlow}{\textsc{l}}
\newcommand{\ToBIminus}{-}
\newcommand{\ToBIplus}{+}

\newcommand{\ToBILstar}{\ToBIlow\kern-0.465em\raisebox{0.35em}{{\scriptsize{*}}}\kern0.09em}
\newcommand{\ToBIHstar}{\ToBIhigh\kern-0.485em\raisebox{0.35em}{{\scriptsize{*}}}\kern0.11em}

\newcommand{\ToBILperc}{\ToBIlow\kern-0.15em\raisebox{0.3em}{{\tiny\%}}\kern0.09em}
\newcommand{\ToBIHperc}{\ToBIhigh\raisebox{0.3em}{{\tiny\%}}\kern0.11em}


\newcommand{\ToBILHstar}{\mbox{\ToBIlow\ToBIplus\ToBIHstar}}
\newcommand{\ToBILstarH}{\mbox{\ToBILstar\ToBIplus\ToBIhigh}}
\newcommand{\ToBIHLstar}{\mbox{\ToBIhigh\ToBIplus\ToBILstar}}
\newcommand{\ToBIHstarL}{\mbox{\ToBIHstar\ToBIplus\ToBIlow}}

\newcommand{\ToBILHperc}{\mbox{\ToBIlow\ToBIminus\ToBIHperc}}
\newcommand{\ToBILpercH}{\mbox{\ToBILperc\ToBIminus\ToBIhigh}}
\newcommand{\ToBIHLperc}{\mbox{\ToBIhigh\ToBIminus\ToBILperc}}
\newcommand{\ToBIHpercL}{\mbox{\ToBIHperc\ToBIminus\ToBIlow}}
