...
presented, but to modifying audio for the benefit of the hearing-impaired.
...
to identify how audio wave-forms should be transformed. \> This
...
is a different process than notating the \textit{existing} speech patterns
...
audio \textit{modifications}, this paper is accompanied by a supplemental
code library which presents several suggestions for extending prosodic
encoding, and also implements a parser for prosody markup which is thereby
enhanced. \> In addition, the library includes features for constructing a
research environment where audio enhancements may be empirically tested.
\> Specifically, given a prior audio sample and an alternative rendering of the
