...
\AtEndDocument{\immediate\write18{cd /home/nlevisrael/gits/ntxh/wip-sebi/ar/code/cpp/qmake-console/projects/gtagml/ngml-sdi-console; ./run-with-args.sh /home/nlevisrael/gits/ntxh/wip-sebi/ar/dev/consoles/gtagml/sdi/section4 (copy)/section4 (copy).gt.tex /home/nlevisrael/gits/ntxh/wip-sebi/ar/dev/consoles/gtagml/sdi/section4 (copy)/section4 (copy).gt.sdi.ntxh /home/nlevisrael/gits/ntxh/wip-sebi/ar/dev/consoles/gtagml/sdi/section4 (copy)/section4 (copy).gt.sdi-prelatex.ntxh; cd -;}}
...
to those who live in New York City (\ref{itm:NYboroughs}, `~r`~e`~f});
in the New York
are but \i{outside} the city (\ref{});
or some combination.
It can also mean \i{all} (\ref{}) or
just \i{some} New Yorkers (\ref{}).
...
Likewise in (\ref{}), only the athletes are referenced via
\i{they played}; but presumably many other people (trainers, coaches, staff)
are encompassed by \q{the team flew}.  And in (\ref{})
...
\q{expectations} \cite{} (meaning assumptions which may be made about
...
\cite{}
or Jiri Benovsky \q{modal perdurants} \cite[p. 8]{}
...
prototypes (\cite[p. 18]{} `~c`~i`~t`~e\p{\svoid{}\svoid{}\svoid{}\svoid{}\svoid{}\svoid{}\svoid{}\svoid{}\svoid{}.\svoid{}\svoid{}\svoid{}\svoid{}\svoid{}\svoid{}\svoid{}\svoid{}{\svoid{}\svoid{}}[ Johnson)
and embodied/enactive patterns of interaction (\cite\p{90]{LakoffJohnson};
`~c`~i`~t`~e\p{\svoid{}\svoid{}\svoid{}[\svoid{}\svoid{}\svoid{}\svoid{}\svoid{}\svoid{}\svoid{}\svoid{}).
...
are formally a synthesis of instance-sets and property-sets \cite{},
\cite{}, \cite{}.  Second,
...
\i{living thing}).
Cognitive schemata, at least in the terms I just laid out, select particularly
...
\mdash{} Figure ~\ref{} is an example of how
...
By way
of illustration, Figure ~\ref{} shows a
destructuring with implicit type annotations.  \input{}
...
\cite{}, \cite{} satisfied by an identity comparison between
...
\cite{}, for example.  Whether these kinds of
