...
void _f_X26_4_(u1 ac_pattern, u4& retv,  QVector<n8>& args, minimal_fn_s0_re4_type fn,
  minimal_fn_s1_re4_type sfn, void* _this) // # 20
{
 switch(ac_pattern)
 {
 ...
 {u2 a1=*(u2*)args[0];r8 a2=*(r8*)args[1];
  auto _sfn = (u4(_min_::*)(u2,r8))(sfn);
  if(_this) retv=((_min_*)_this->*_sfn)(a1,a2);
  else retv=((u4(*)(u2,r8))fn)(a1,a2);
 } break;

 case 255: // 2 args, higher-number pretype first
 {r8 a1=*(r8*)args[0];u2 a2=*(u2*)args[1];
  auto _sfn = (u4(_min_::*)(r8,u2))(sfn);
  if(_this) retv=((_min_*)_this->*_sfn)(a1,a2);
  else retv=((u4(*)(r8,u2))fn)(a1,a2);
 } break;
