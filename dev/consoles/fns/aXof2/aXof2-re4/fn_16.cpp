...
void _f_X16_4_(u1 ac_pattern, u4& retv,  QVector<n8>& args, minimal_fn_s0_re4_type fn,
  minimal_fn_s1_re4_type sfn, void** _this) // # 13
{
 switch(ac_pattern)
 {
 ...
 {u1 a1=*(u1*)args[0];r8 a2=*(r8*)args[1];
  auto _sfn = (u4(_min_::*)(u1,r8))(sfn);
  if(_this) retv=((_min_*)_this->*_sfn)(a1,a2);
  else retv=((u4(*)(u1,r8))fn)(a1,a2);
 } break;

 case 255: // 2 args, higher-number pretype first
 {r8 a1=*(r8*)args[0];u1 a2=*(u1*)args[1];
  auto _sfn = (u4(_min_::*)(r8,u1))(sfn);
  if(_this) retv=((_min_*)_this->*_sfn)(a1,a2);
  else retv=((u4(*)(r8,u1))fn)(a1,a2);
 } break;
