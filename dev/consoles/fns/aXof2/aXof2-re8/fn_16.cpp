...
void _f_X16_8_(u1 ac_pattern, n8& retv,  QVector<n8>& args, minimal_fn_s0_re8_type fn,
  minimal_fn_s1_re8_type sfn, void** _this) // # 13
{
 switch(ac_pattern)
 {
 ...
 {u1 a1=*(u1*)args[0];r8 a2=*(r8*)args[1];
  auto _sfn = (n8(_min_::*)(u1,r8))(sfn);
  if(_this) retv=((_min_*)*_this->*_sfn)(a1,a2);
  else retv=((n8(*)(u1,r8))fn)(a1,a2);
 } break;

 case 255: // 2 args, higher-number pretype first
 {r8 a1=*(r8*)args[0];u1 a2=*(u1*)args[1];
  auto _sfn = (n8(_min_::*)(r8,u1))(sfn);
  if(_this) retv=((_min_*)*_this->*_sfn)(a1,a2);
  else retv=((n8(*)(r8,u1))fn)(a1,a2);
 } break;
