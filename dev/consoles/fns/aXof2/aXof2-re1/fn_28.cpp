...
void _f_X28_1_(u1 ac_pattern, u1& retv,  QVector<n8>& args, minimal_fn_s0_re1_type fn,
  minimal_fn_s1_re1_type sfn, void** _this) // # 22
{
 switch(ac_pattern)
 {
 ...
 {u2 a1=*(u2*)args[0];n8 a2=*(n8*)args[1];
  auto _sfn = (u1(_min_::*)(u2,n8))(sfn);
  if(_this) retv=((_min_*)_this->*_sfn)(a1,a2);
  else retv=((u1(*)(u2,n8))fn)(a1,a2);
 } break;

 case 255: // 2 args, higher-number pretype first
 {n8 a1=*(n8*)args[0];u2 a2=*(u2*)args[1];
  auto _sfn = (u1(_min_::*)(n8,u2))(sfn);
  if(_this) retv=((_min_*)_this->*_sfn)(a1,a2);
  else retv=((u1(*)(n8,u2))fn)(a1,a2);
 } break;
