...
void _f_X12_1_(u1 ac_pattern, u1& retv,  QVector<n8>& args, minimal_fn_s0_re1_type fn,
  minimal_fn_s1_re1_type sfn, void** _this) // # 9
{
 switch(ac_pattern)
 {
 ...
 {u1 a1=*(u1*)args[0];u2 a2=*(u2*)args[1];
  auto _sfn = (u1(_min_::*)(u1,u2))(sfn);
  if(_this) retv=((_min_*)_this->*_sfn)(a1,a2);
  else retv=((u1(*)(u1,u2))fn)(a1,a2);
 } break;

 case 255: // 2 args, higher-number pretype first
 {u2 a1=*(u2*)args[0];u1 a2=*(u1*)args[1];
  auto _sfn = (u1(_min_::*)(u2,u1))(sfn);
  if(_this) retv=((_min_*)_this->*_sfn)(a1,a2);
  else retv=((u1(*)(u2,u1))fn)(a1,a2);
 } break;
