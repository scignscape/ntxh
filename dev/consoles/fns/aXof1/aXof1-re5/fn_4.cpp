...
void _f_X4_5_(u1 ac, QByteArray& retv,  QVector<n8>& args, minimal_fn_s0_re5_type fn,
  minimal_fn_s1_re5_type sfn, void* _this)
{
 ...
 case 2:
  {u4 a1=*(u4*)args[0];u4 a2=*(u4*)args[1];
   auto _sfn = (QByteArray(_min_::*)(u4,u4))(sfn);
   if(_this) retv=((_min_*)_this->*_sfn)(a1,a2);
   else retv=((QByteArray(*)(u4,u4))fn)(a1,a2);
  } break;
 ...
 case 7:
  {u4 a1=*(u4*)args[0];u4 a2=*(u4*)args[1];u4 a3=*(u4*)args[2];u4 a4=*(u4*)args[3];u4 a5=*(u4*)args[4];u4 a6=*(u4*)args[5];u4 a7=*(u4*)args[6];
   auto _sfn = (QByteArray(_min_::*)(u4,u4,u4,u4,u4,u4,u4))(sfn);
   if(_this) retv=((_min_*)_this->*_sfn)(a1,a2,a3,a4,a5,a6,a7);
   else retv=((QByteArray(*)(u4,u4,u4,u4,u4,u4,u4))fn)(a1,a2,a3,a4,a5,a6,a7);
  } break;
 ...
 case 8:
  {u4 a1=*(u4*)args[0];u4 a2=*(u4*)args[1];u4 a3=*(u4*)args[2];u4 a4=*(u4*)args[3];u4 a5=*(u4*)args[4];u4 a6=*(u4*)args[5];u4 a7=*(u4*)args[6];u4 a8=*(u4*)args[7];
   auto _sfn = (QByteArray(_min_::*)(u4,u4,u4,u4,u4,u4,u4,u4))(sfn);
   if(_this) retv=((_min_*)_this->*_sfn)(a1,a2,a3,a4,a5,a6,a7,a8);
   else retv=((QByteArray(*)(u4,u4,u4,u4,u4,u4,u4,u4))fn)(a1,a2,a3,a4,a5,a6,a7,a8);
  } break;
