...
void _f_X9_7_(u1 ac, QVariant& retv,  QVector<n8>& args, minimal_fn_s0_re7_type fn,
  minimal_fn_s1_re7_type sfn, void** _this)
{
 ...
 case 1:
  {n8 a1=*(n8*)args[0];
   auto _sfn = (QVariant(_min_::*)(n8))(sfn);
   if(_this) retv=((_min_*)*_this->*_sfn)(a1);
   else retv=((QVariant(*)(n8))fn)(a1);
  } break;

 case 2:
  {n8 a1=*(n8*)args[0];n8 a2=*(n8*)args[1];
   auto _sfn = (QVariant(_min_::*)(n8,n8))(sfn);
   if(_this) retv=((_min_*)*_this->*_sfn)(a1,a2);
   else retv=((QVariant(*)(n8,n8))fn)(a1,a2);
  } break;
 ...
 case 7:
  {n8 a1=*(n8*)args[0];n8 a2=*(n8*)args[1];n8 a3=*(n8*)args[2];n8 a4=*(n8*)args[3];n8 a5=*(n8*)args[4];n8 a6=*(n8*)args[5];n8 a7=*(n8*)args[6];
   auto _sfn = (QVariant(_min_::*)(n8,n8,n8,n8,n8,n8,n8))(sfn);
   if(_this) retv=((_min_*)*_this->*_sfn)(a1,a2,a3,a4,a5,a6,a7);
   else retv=((QVariant(*)(n8,n8,n8,n8,n8,n8,n8))fn)(a1,a2,a3,a4,a5,a6,a7);
  } break;
 ...
 case 8:
  {n8 a1=*(n8*)args[0];n8 a2=*(n8*)args[1];n8 a3=*(n8*)args[2];n8 a4=*(n8*)args[3];n8 a5=*(n8*)args[4];n8 a6=*(n8*)args[5];n8 a7=*(n8*)args[6];n8 a8=*(n8*)args[7];
   auto _sfn = (QVariant(_min_::*)(n8,n8,n8,n8,n8,n8,n8,n8))(sfn);
   if(_this) retv=((_min_*)*_this->*_sfn)(a1,a2,a3,a4,a5,a6,a7,a8);
   else retv=((QVariant(*)(n8,n8,n8,n8,n8,n8,n8,n8))fn)(a1,a2,a3,a4,a5,a6,a7,a8);
  } break;
