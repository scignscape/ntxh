...
DEFINES += CAPTK_STYLESHEET_FILE=\\\"CAPTK_STYLESHEET_FILE\\\"
 ...
 # this is supposed to split to a list used by fFeaturePanel ...
...
INCLUDEPATH += \
  ...
  $$SRC_GROUP_DIR/CaPTk-applications \
  ...
  $$SRC_GROUP_DIR/CaPTk-applications/individualApps/sbrt_source/src/common_includes \
  $$SRC_GROUP_DIR/CaPTk-applications/WhiteStripe_includes \
  $$SRC_GROUP_DIR/CaPTk-applications/BreastTexturePipeline/src/depends \
  $$SRC_GROUP_DIR/CaPTk-applications/FeatureExtraction/src
...
HEADERS += \
  ...
  $$SRC_DIR/gui/fSegmentationPanel.h \
...
SOURCES += \
  ...
  $$SRC_DIR/gui/SlicerManagerCommand.cpp \
