...
public:
    ...
    {
        SSDialog->setWindowTitle(QCoreApplication::translate("SSDialog", "Save snapshot", nullptr));
        label->setText(QCoreApplication::translate("SSDialog", "Output folder  ", nullptr));
        browseDir->setText(QCoreApplication::translate("SSDialog", "...", nullptr));
        label_2->setText(QCoreApplication::translate("SSDialog", "Base name  ", nullptr));
        label_3->setText(QCoreApplication::translate("SSDialog", "Counter", nullptr));
        alllayersCheckBox->setText(QCoreApplication::translate("SSDialog", "Snap All Layers", nullptr));
#if QT_CONFIG(tooltip)
        tiledSaveCheckBox->setToolTip(QCoreApplication::translate("SSDialog", "If checked, save each image independently, allowing to later combine the saved images into a very very large image", nullptr));
#endif // QT_CONFIG(tooltip)
        tiledSaveCheckBox->setText(QCoreApplication::translate("SSDialog", "Tiled Save", nullptr));
        label_5->setText(QCoreApplication::translate("SSDialog", "Background", nullptr));
        backgroundComboBox->setItemText(0, QCoreApplication::translate("SSDialog", "MeshLab Gradient", nullptr));
        backgroundComboBox->setItemText(1, QCoreApplication::translate("SSDialog", "Alpha Transparent", nullptr));
        backgroundComboBox->setItemText(2, QCoreApplication::translate("SSDialog", "Solid White", nullptr));
        backgroundComboBox->setItemText(3, QCoreApplication::translate("SSDialog", "Solid Black", nullptr));

#if QT_CONFIG(tooltip)
        label_4->setToolTip(QCoreApplication::translate("SSDialog", "The resolution of the screenshot is the resolution of the current window multiplied by this number", nullptr));
#endif // QT_CONFIG(tooltip)
        label_4->setText(QCoreApplication::translate("SSDialog", "Screen Multiplier  ", nullptr));
#if QT_CONFIG(tooltip)
        resolutionSpinBox->setToolTip(QCoreApplication::translate("SSDialog", "The resolution of the screenshot is the resolution of the current window multiplied by this number", nullptr));
#endif // QT_CONFIG(tooltip)
