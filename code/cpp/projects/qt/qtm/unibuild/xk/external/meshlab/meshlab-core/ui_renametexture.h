...
public:
    ...
    {
        RenameTextureDialog->setWindowTitle(QCoreApplication::translate("RenameTextureDialog", "Dialog", nullptr));
        okButton->setText(QCoreApplication::translate("RenameTextureDialog", "OK", nullptr));
        cancelButton->setText(QCoreApplication::translate("RenameTextureDialog", "Cancel", nullptr));
        newtexturename->setText(QString());
        label->setText(QCoreApplication::translate("RenameTextureDialog", "<html><head><meta name=\"qrichtext\" content=\"1\" /></head><body style=\" white-space: pre-wrap; font-family:MS Shell Dlg; font-weight:400; font-style:normal; text-decoration:none;\"><p style=\" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Texture Name</p></body></html>", nullptr));
        searchButton->setText(QCoreApplication::translate("RenameTextureDialog", "Search Texture", nullptr));
    } // retranslateUi
