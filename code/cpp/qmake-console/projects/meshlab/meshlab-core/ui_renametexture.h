...
public:
    ...
    {
        RenameTextureDialog->setWindowTitle(QApplication::translate("RenameTextureDialog", "Dialog", nullptr));
        okButton->setText(QApplication::translate("RenameTextureDialog", "OK", nullptr));
        cancelButton->setText(QApplication::translate("RenameTextureDialog", "Cancel", nullptr));
        newtexturename->setText(QString());
        label->setText(QApplication::translate("RenameTextureDialog", "<html><head><meta name=\"qrichtext\" content=\"1\" /></head><body style=\" white-space: pre-wrap; font-family:MS Shell Dlg; font-weight:400; font-style:normal; text-decoration:none;\"><p style=\" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Texture Name</p></body></html>", nullptr));
        searchButton->setText(QApplication::translate("RenameTextureDialog", "Search Texture", nullptr));
    } // retranslateUi
