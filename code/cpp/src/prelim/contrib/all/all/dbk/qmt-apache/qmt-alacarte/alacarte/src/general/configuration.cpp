...
Configuration::Configuration(	boost::program_options::options_description& cmd_desc,
								...
								int argc, char** argv)
 : supplemental_qmap_(nullptr), ConfigFileUsed(false)
{
...
const boost::any& Configuration::getValueByKey(const string& key, void** alt) const
{
 if(supplemental_qmap_)
 {
  static boost::any nothing {};
  *alt = &(*(QMap<QString, QString>*) supplemental_qmap_)[QString::fromStdString(key)];
  return nothing;
 }
