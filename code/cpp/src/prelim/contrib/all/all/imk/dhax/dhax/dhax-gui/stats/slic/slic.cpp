...
void SLIC::getSupperpixels(cv::Mat input, QString output, const int numOfSuperpixels, const int compactness, const double treshold)
{
 ...
 qDebug() << "SLIC out file: " << output;
 cv::imwrite(output.toStdString(), input);
