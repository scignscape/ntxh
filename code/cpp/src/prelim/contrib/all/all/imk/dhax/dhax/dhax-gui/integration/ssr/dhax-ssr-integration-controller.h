...
#ifndef DHAX_SSR_INTEGRATION_CONTROLLER__H
#define DHAX_SSR_INTEGRATION_CONTROLLER__H
...
class DHAX_SSR_Integration_Controller : public DHAX_Integration_Controller
{
 DHAX_SSR_Integration_Data* integration_data_;
 DHAX_Application_Controller* application_controller_;

public:

 DHAX_SSR_Integration_Controller();

 ACCESSORS(DHAX_SSR_Integration_Data* ,integration_data)
