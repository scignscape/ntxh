...
#include "image-annotation-info.h"
...
Image_Annotation_Entity::Image_Annotation_Entity()
  :  axfi_group_(nullptr)
{
 al.object_ = nullptr;
}

AL_INIT(ImageAnnotation)

//void Image_Annotation_Entity::alinit()
//{
// al.object_ = new ImageAnnotation;
//}


void Image_Annotation_Entity::supply_data(QByteArray& qba)
{
...
void Image_Annotation_Entity::absorb_data(const QByteArray& qba)
{
 QDataStream qds(qba);
// qds >> a_string_ >> a_number_;
