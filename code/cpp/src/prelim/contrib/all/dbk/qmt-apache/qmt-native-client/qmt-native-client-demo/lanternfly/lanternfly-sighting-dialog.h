...
#ifndef LANTERN_SIGHTING_DIALOG__H
#define LANTERN_SIGHTING_DIALOG__H
...
class Lanternfly_Sighting_Dialog : public QDialog
{
 ...
 QComboBox* plant_combo_box_;
 QComboBox* location_kind_combo_box_;
 QComboBox* specimen_stage_combo_box_;
 QComboBox* follow_up_combo_box_;
...
public:
 ...
 Lanternfly_Sighting_Dialog(QWidget* parent = nullptr);

 ~Lanternfly_Sighting_Dialog();
...
#endif  // LANTERN_SIGHTING_DIALOG__H
