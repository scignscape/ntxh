...
#ifndef LANTERN_SIGHTING_FILTER_DIALOG__H
#define LANTERN_SIGHTING_FILTER_DIALOG__H
...
class Lanternfly_Sighting_Filter_Dialog : public QDialog
{
 ...
 QGroupBox* plants_table_group_box_;
 QVBoxLayout* plants_table_layout_;
 QTableWidget* plants_table_;
 ...
 QCheckBox* indicate_without_sighting_;


 QGroupBox* geo_group_box_;
 QComboBox* geo_combo_box_;
 QComboBox* density_combo_box_;
 QFormLayout* geo_layout_;
 QHBoxLayout* density_merge_layout_;
 QCheckBox* density_merge_check_box_;
 QPushButton* density_merge_reset_;
...
public:
 ...
 Lanternfly_Sighting_Filter_Dialog(QWidget* parent = nullptr);

 ~Lanternfly_Sighting_Filter_Dialog();
...
#endif  // LANTERN_SIGHTING_FILTER_DIALOG__H
