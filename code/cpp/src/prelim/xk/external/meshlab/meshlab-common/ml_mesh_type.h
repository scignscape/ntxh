...
public :
    ...
    CMeshO(const CMeshO& oth) : CMeshO() {
        //? MeshAppendConst does not exist?
        //vcg::tri::Append<CMeshO, CMeshO>::MeshAppendConst(*this, oth);
     vcg::tri::Append<CMeshO, CMeshO>::Mesh(*this, const_cast<CMeshO&>( oth ) );
    }
    ...
    CMeshO& operator=(const CMeshO& oth) {
        Clear();
        //? MeshCopyConst does not exist?
        //vcg::tri::Append<CMeshO, CMeshO>::MeshCopyConst(*this, oth);
        vcg::tri::Append<CMeshO, CMeshO>::MeshCopy(*this, const_cast<CMeshO&>( oth ) );
        return *this;
    }
};
