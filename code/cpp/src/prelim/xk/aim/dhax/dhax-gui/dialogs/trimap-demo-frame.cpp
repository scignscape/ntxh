...
#include "trimap-demo-frame.h"



Trimap_Demo_Frame::Trimap_Demo_Frame(QString path,
...
// DGI_Image* hull_poly_color_mean;
 ...
 fg_button_ = image_path_as_qbutton(this, path.arg("fg"), image_width_, image_height_);
 fg_label_ = image_path_as_qlabel(this, path.arg("fg"), large_image_width_, large_image_height_);
 left_layout_->addWidget(fg_button_, 0, 0);
 large_images_->addWidget(fg_label_);
 fg_button_->setCheckable(true);
...
QPushButton* Trimap_Demo_Frame::image_path_as_qbutton(QWidget* parent, QString path, u4 image_width, u4 image_height)
{
 if(image_height == 0)
...
QLabel* Trimap_Demo_Frame::image_path_as_qlabel(QWidget* parent, QString path, u4 image_width, u4 image_height)
{
 if(image_height == 0)
   image_height = image_width;
