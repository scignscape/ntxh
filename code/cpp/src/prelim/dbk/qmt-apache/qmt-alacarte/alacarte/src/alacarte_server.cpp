...
#define OPT(_name, _shortcut)	(string(_name).append(",").append(_shortcut)).c_str()
   ...
   (OPT(opt::server::server_port, "p"),		value<string>()->required()->default_value(DEFAULT_PORT)/*->value_name("port")*/,			"port to bind the server")
...
int main(int argc, char** argv)
{
 ...
 QGuiApplication::processEvents(); // this should allow `QApplication` to complete its initialization
