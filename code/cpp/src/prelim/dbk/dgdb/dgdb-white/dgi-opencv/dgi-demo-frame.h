...
#ifndef DGI_DEMO_FRAME__H
#define DGI_DEMO_FRAME__H
...
class DGI_Demo_Frame : public QFrame
{
 ...
 QPushButton* blurred_button_;

 QPushButton* draw_contours_button_;
 QPushButton* circles_button_;

 QPushButton* hull_poly_button_;
 QPushButton* hull_poly_color_mean_button_;

 QGridLayout* left_layout_;
 QHBoxLayout* main_layout_;

 QScrollArea* large_image_scroll_;

 QStackedWidget* large_images_;

 QLabel* src_label_;
 QLabel* blurred_label_;

 QLabel* draw_contours_label_;
 QLabel* circles_label_;

 QLabel* hull_poly_label_;
 QLabel* hull_poly_color_mean_label_;

 int image_width_;
 int large_image_width_;

 int image_height_;
 int large_image_height_;


public:

 DGI_Demo_Frame(Demo_Transform_Group& dtg,
   int image_width, int large_image_width,
   int scroll_minimum_width,
   int image_height = 0, int large_image_height = 0);
