...
class Index {
    private:
        ...
        */
        void insert(std::vector<std::unordered_set<Element*>*>& table, std::vector<QVariant>& dict, Element* e, QVariant val) {
