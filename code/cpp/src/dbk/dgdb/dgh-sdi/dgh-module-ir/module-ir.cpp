...
void Module_IR::check_translate_cmd(QString& c)
{
...
void Module_IR::run_lines(QString proc_name)
{
 ...
 for(auto& line: lines)
 {
  if(line.cmd)
  {
   auto ff = (void(GTagML_Module::*)(QString)) line.fn.fn1;
   (gtagml_module_->*(ff))(*line.cmd);
  }
  else
  {
   auto ff = (void(GTagML_Module::*)()) line.fn.fn0;
   (gtagml_module_->*(ff))();
  }
 }
}

void Module_IR::read_lines(QString lines)
{
 int pos = 0;
...
void Module_IR::read_line(QString inst, QString arg)
{
 static QMap<QString, QPair<void*, fn1_t>> static_map {{

  { "gt_compile_file",
    { gtagml_module_, (fn1_t) &GTagML_Module::compile_gt_file} },

  { "gt_compile_folder",
    { gtagml_module_, (fn1_t) &GTagML_Module::compile_gt_folder} },

  { "gt_compile_manuscript",
    { gtagml_module_, (fn1_t) &GTagML_Module::compile_gt_manuscript} },
...
void Module_IR::read_line(QString inst)
{
...
void Module_IR::parse_fn_line(QString line)
{
// if(line[3] == 'p')
// {
