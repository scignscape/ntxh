...
QLabel* src_label = dgi.as_qlabel();
src_label->show();

QLabel* blurred_label = dtg.blurred->as_qlabel();
blurred_label->show();


QLabel* draw_contours_label = dtg.draw_contours->as_qlabel();
draw_contours_label->show();

QLabel* circles_label = dtg.circles->as_qlabel();
circles_label->show();

QLabel* hull_poly_label = dtg.hull_poly->as_qlabel();
hull_poly_label->show();

QLabel* hull_poly_color_mean_label = dtg.hull_poly_color_mean->as_qlabel();
hull_poly_color_mean_label->show();
