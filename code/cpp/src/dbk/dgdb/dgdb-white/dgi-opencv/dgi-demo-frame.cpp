...
DGI_Demo_Frame::DGI_Demo_Frame(Demo_Transform_Group& dtg,
  int image_width, int large_image_width,
  int scroll_minimum_width,
  int image_height, int large_image_height)
...
// DGI_Image* hull_poly_color_mean;
 ...
 src_button_ = dtg.src->as_qbutton(image_width_, image_height_);
 src_label_ = dtg.src->as_qlabel(large_image_width_, large_image_height_);
 left_layout_->addWidget(src_button_, 0, 0);
 large_images_->addWidget(src_label_);
 src_button_->setCheckable(true);
 src_button_->setChecked(true);
 left_buttons_->addButton(src_button_);

 blurred_button_ = dtg.blurred->as_qbutton(image_width_, image_height_);
 blurred_label_ = dtg.blurred->as_qlabel(large_image_width_, large_image_height_);
 left_layout_->addWidget(blurred_button_, 0, 1);
 large_images_->addWidget(blurred_label_);
 blurred_button_->setCheckable(true);
 left_buttons_->addButton(blurred_button_);


 draw_contours_button_ = dtg.draw_contours->as_qbutton(image_width_, image_height_);
 draw_contours_label_ = dtg.draw_contours->as_qlabel(large_image_width_, large_image_height_);
 left_layout_->addWidget(draw_contours_button_, 1, 0);
 large_images_->addWidget(draw_contours_label_);
 draw_contours_button_->setCheckable(true);
 left_buttons_->addButton(draw_contours_button_);


 circles_button_ = dtg.circles->as_qbutton(image_width_, image_height_);
 circles_label_ = dtg.circles->as_qlabel(large_image_width_, large_image_height_);
 left_layout_->addWidget(circles_button_, 1, 1);
 large_images_->addWidget(circles_label_);
 circles_button_->setCheckable(true);
 left_buttons_->addButton(circles_button_);


 hull_poly_button_ = dtg.hull_poly->as_qbutton(image_width_, image_height_);
 hull_poly_label_ = dtg.hull_poly->as_qlabel(large_image_width_, large_image_height_);
 left_layout_->addWidget(hull_poly_button_, 2, 0);
 large_images_->addWidget(hull_poly_label_);
 hull_poly_button_->setCheckable(true);
 left_buttons_->addButton(hull_poly_button_);


 hull_poly_color_mean_button_ = dtg.hull_poly_color_mean->as_qbutton(image_width_, image_height_);
 hull_poly_color_mean_label_ = dtg.hull_poly_color_mean->as_qlabel(large_image_width_, large_image_height_);
 left_layout_->addWidget(hull_poly_color_mean_button_, 2, 1);
 large_images_->addWidget(hull_poly_color_mean_label_);
 hull_poly_color_mean_button_->setCheckable(true);
 left_buttons_->addButton(hull_poly_color_mean_button_);
