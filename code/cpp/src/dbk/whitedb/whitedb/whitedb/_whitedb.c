...
* $Version: $
*
* Copyright (c) Andri Rebane 2009, Priit J?rv 2009,2010,2013,2014
*
* This file is part of WhiteDB
*
* WhiteDB is free software: you can redistribute it and/or modify
...
* $Version: $
*
* Copyright (c) Enar Reilent 2009, Priit J?rv 2010,2011,2013,2014
*
* This file is part of WhiteDB
*
* WhiteDB is free software: you can redistribute it and/or modify
...
* $Version: $
*
* Copyright (c) Priit J?rv 2010,2011,2013,2014
*
* This file is part of WhiteDB
*
* WhiteDB is free software: you can redistribute it and/or modify
...
gint db_tfqueue_rlock(void * db) {
  ...
  if(prev) {
    ...
    if(prevp->_class_ == LOCKQ_READ && prevp->waiting == 0) {
      lockp->waiting = 0;
    } else {
      lockp->waiting = 1;
    }
...
#error This code needs Linux SYS_futex service to function
    ...
    if(lockp->next) {
      lock_queue_node *nextp = offsettoptr(db, lockp->next);
      if(nextp->_class_ == LOCKQ_READ && nextp->waiting) {
        nextp->waiting = 0;
        syn_addr = &nextp->waiting;
      }
    }
...
gint db_tfqueue_rulock(void * db, gint lock) {
  ...
  if(lockp->next) {
    ...
    if(nextp->waiting && (!lockp->prev || nextp->_class_ == LOCKQ_READ)) {
      nextp->waiting = 0;
      syn_addr = &nextp->waiting;
    }
  } else if(dbh->locks.tail == lock) {
