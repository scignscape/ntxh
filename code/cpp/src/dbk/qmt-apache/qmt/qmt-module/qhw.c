...
static int qhw_handler(request_rec *req)
{
 void* details = NULL;
 int positive_response = 0;

 int r = _parse_url_via_start("-qhw", req->uri, "/qhw", &positive_response, DECLINED, &details);
//    if (strcmp(req->handler, "qhw"))
//    {
//        return DECLINED;
//    }
...
static void qhw_register_hooks(apr_pool_t *p)
{
    printf("\n ** qhw_register_hooks  **\n\n");
    ap_hook_handler(qhw_handler, NULL, NULL, APR_HOOK_MIDDLE);
}

/* Dispatch list for API hooks */
module AP_MODULE_DECLARE_DATA qhw_module = {
    ...
    qhw_register_hooks  /* register hooks */
};
