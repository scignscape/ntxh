...
Forge_Bucket::Forge_Bucket(QString bucket_key,
  QString owner, n8 created_date, Policy_Options policy)
 : bucket_key_(bucket_key), owner_(owner),
   created_date_(created_date), policy_(policy)
{
