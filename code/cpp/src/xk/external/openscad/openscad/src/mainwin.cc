...
// // mosaic
#include "/home/nlevisrael/openscad/mosaic/mosaic-menubar.h"
//#include "/home/nlevisrael/openscad/mosaic/mosaic-menubar.cpp"
#include <QLinearGradient>

//#define QMenuBar Mosaic_Menubar
...
// Ui_MainWindow::menubar->setStyleSheet(R"(
//  QMenu::item#axfi{background-color: qlineargradient(x1:0, y1:0, x2:0, y2:1,
//    stop:0 white, stop:yellow darkgray);
//    spacing: 3px; /* spacing between menu bar items */
//  })");

// Ui_MainWindow::menuCDBi->setObjectName("axfi_submenu1");


// Ui_MainWindow::menuCDBi->setStyleSheet(R"(
//  QMenu::item{
//    background-color: qlineargradient(x1:0, y1:0, x2:0, y2:1,
//    stop:0 pink, stop:1 lightgray);
//  })");

// QMenu* axfi_submenu1 = Ui_MainWindow::menuAXFi;

// axfi_submenu1->menuAction()->setProperty("mosaic", true);
...
// Mosaic_Menubar::add_action_data(axfi_submenu1->menuAction(),
//   "QLinearGradient", qlg);
// axfi_submenu1->setObjectName("axfi_submenu1");
// axfi_submenu1->addAction("Take ScreenShot", [this]
//   {
//    Mosaic_Menubar::handle_screenshot(this->winId());
//   });


 QMenu* axfi_submenu = Ui_MainWindow::menuAXFi;

 QMenu* help_submenu = Ui_MainWindow::menuHelp;
 Ui_MainWindow::menubar->add_text_separator_around(axfi_submenu, help_submenu);

 axfi_submenu->menuAction()->setProperty("mosaic", true);
 QLinearGradient* qlg = new QLinearGradient(0,0,0,400);
 qlg->setColorAt(0.0, QColor(250,255,245));
 qlg->setColorAt(0.1, QColor(125,0,120));
 Mosaic_Menubar::add_action_data(axfi_submenu->menuAction(),
   "QLinearGradient", qlg);
 axfi_submenu->setObjectName("axfi_submenu");

  axfi_submenu->addAction("Take ScreenShot", [this]
    {
     Mosaic_Menubar::handle_screenshot(this->winId());
    });

 Ui_MainWindow::menubar->setObjectName("the_Mosaic_Menubar");

 Ui_MainWindow::menubar->setStyleSheet(R"(#the_Mosaic_Menubar{
   background-color: qlineargradient(x1:0, y1:0, x2:0, y2:1,
 ...
 Ui_MainWindow::menubar->use_default_stylesheet("the_Mosaic_Menubar");

 Ui_MainWindow::menubar->add_to_style_sheet(R"(#axfi_submenu::item {
   background-color: qlineargradient(x1:0, y1:0, x2:0, y2:1,
                                     stop:0 pink, stop:1 lightgray);
 }

 #axfi_submenu::item:selected {
   color:blue;
   background-color: qlineargradient(x1:0, y1:0, x2:0, y2:1,
...
// Ui_MainWindow::menubar->add_to_style_sheet(R"(#axfi_submenu1::item {
//   background-color: qlineargradient(x1:0, y1:0, x2:0, y2:1,
//                                     stop:0 pink, stop:1 lightgray);
// }

// #axfi_submenu1::item:selected {
//   color:blue;
//   background-color: qlineargradient(x1:0, y1:0, x2:0, y2:1,
//                                     stop:0 pink, stop:1 darkgray);
// }
