...
#ifndef AXLPOINTSETWRITER_H
#define AXLPOINTSETWRITER_H
...
class AXLCORE_EXPORT axlPointSetWriter : public axlAbstractDataWriter
{
    Q_OBJECT

public :
      axlPointSetWriter(void);
     ~axlPointSetWriter(void);
