...
# define VXL_COMPILER_IS_IntelDPCPP 0
# define VXL_COMPILER_IS_IntelClang 0
...
# undef VXL_COMPILER_IS_IntelDPCPP
# define VXL_COMPILER_IS_IntelDPCPP 1

#elif defined(__clang__) && defined(__INTEL_CLANG_COMPILER)
# undef VXL_COMPILER_IS_IntelClang
# define VXL_COMPILER_IS_IntelClang 1
