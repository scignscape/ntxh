 ...
 * Date:    2008/02/25                          \n
 *
 * $Id: mdsSignal.h 1863 2010-08-31 20:40:15Z spanel $
 *
 * Description:
...
class CSignal
    ...
    , public mds::base::CLibraryLockableObject<CSignal<R, P1, P2, P3, P4> >
{
public:
    //! Smart pointer type.
    ...
    typedef typename mds::base::CLibraryLockableObject<CSignal>::CLock tLock;
