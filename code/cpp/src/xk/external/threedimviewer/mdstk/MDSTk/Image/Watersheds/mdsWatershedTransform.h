...
#ifndef MDS_WatershedTransform_H
#define MDS_WatershedTransform_H
 ...
 */
template <class I>
class CWatershedTransform : public mds::base::CHasOptions
{
public:
...
public:
        ...
        , m_CurrentRegion(0)
    {
        ...
        MDS_STATIC_ASSERT(CTypeTraits<tPixel>::isFundamental && CTypeTraits<tPixel>::isIntegral,
...
#endif // MDS_WatershedTransform_H
