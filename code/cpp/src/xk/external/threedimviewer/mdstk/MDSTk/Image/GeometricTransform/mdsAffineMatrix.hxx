 ...
 * Date:    2008/12/16                          \n
 *
 * $Id: mdsAffineMatrix.hxx 2084 2012-02-13 10:23:58Z spanel $
 *
 * Description:
...
template <typename U>
inline CAffineMatrix::CAffineMatrix(const mds::math::CStaticMatrix<U,3,3>& Matrix) : tMatrix(Matrix)
{
}
