 ...
 * Date:    2004/10/17                          \n
 *
 * $Id: mdsScopedPtr.h 1863 2010-08-31 20:40:15Z spanel $
 *
 * Description:
...
#ifndef MDS_ScopedPtr_H
#define MDS_ScopedPtr_H
...
public:
    ...
    CScopedPtr(T *p) : m_pInstance(p), m_bDestroy(true) {}
