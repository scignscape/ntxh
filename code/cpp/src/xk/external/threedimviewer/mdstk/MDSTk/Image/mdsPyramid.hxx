 ...
 * Date:    2004/04/20                          \n
 *
 * $Id: mdsPyramid.hxx 2100 2012-02-17 07:36:55Z spanel $
 * 
 * Description:
...
//=============================================================================
/*
 * Implementation of the mds::CPyramid class template.
 */
...
{
    MDS_CHECK(Levels >= 1 && SubSampling >= 2, return false);
...
{
    MDS_ASSERT(Level >= 0 && Level < m_Levels);
