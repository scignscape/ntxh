 ...
 * Date:    2005/09/20                          \n
 *
 * $Id: mdsCanny.hxx 2098 2012-02-16 23:50:36Z spanel $
 *
 * Description:
 * - Canny edge detector.
 */
...
bool CCanny<I>::operator()(const tImage& SrcImage, tImage& DstImage)
{
    ...
    for( tSize y = 0; y < YCount; ++y )
    {
        ...
        {
            float fValue = mds::math::getAbs(float(GradImageX(x, y)) - fGray);
            fValue += mds::math::getAbs(float(GradImageY(x, y)) - fGray);
