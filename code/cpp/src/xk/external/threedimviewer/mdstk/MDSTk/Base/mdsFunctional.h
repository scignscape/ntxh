 ...
 * Date:    2008/07/08                          \n
 *
 * $Id: mdsFunctional.h 2084 2012-02-13 10:23:58Z spanel $
 *
 * Description:
 * - Basic functional objects.
 */

#ifndef MDS_Functional_H
#define MDS_Functional_H
...
public:
    ...
    void operator ()(T& Value)
    {
        mds::math::limit(Value, m_Min, m_Max);
    }
...
public:
    ...
    void operator ()(T& Value)
    {
        mds::math::cut(Value, m_Min, m_Max, m_NewValue);
    }
...
public:
    ...
    {
        m_Max = mds::math::getMax(Value, m_Max);
    }
...
public:
    ...
    void operator ()(const T& Value)
    {
        m_Min = mds::math::getMin(Value, m_Min);
    }
