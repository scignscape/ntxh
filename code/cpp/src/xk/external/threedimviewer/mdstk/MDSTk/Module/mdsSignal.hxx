 ...
 * Date:    2008/02/25                          \n
 *
 * $Id: mdsSignal.hxx 1863 2010-08-31 20:40:15Z spanel $
 *
 * Description:
...
{
    MDS_STATIC_ASSERT(NUM_OF_PARAMS == 0, Bad_number_of_signal_parameters);
...
{
    MDS_STATIC_ASSERT(NUM_OF_PARAMS == 1, Bad_number_of_signal_parameters);
...
{
    MDS_STATIC_ASSERT(NUM_OF_PARAMS == 2, Bad_number_of_signal_parameters);
...
{
    MDS_STATIC_ASSERT(NUM_OF_PARAMS == 3, Bad_number_of_signal_parameters);
...
{
    MDS_STATIC_ASSERT(NUM_OF_PARAMS == 4, Bad_number_of_signal_parameters);
