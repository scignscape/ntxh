 ...
 * Date:    2008/07/21                          \n
 *
 * $Id: mdsImageFunctional.h 1863 2010-08-31 20:40:15Z spanel $
 *
 * Description:
 * - Functional objects applicable to image pixels.
 */

#ifndef MDS_ImageFunctional_H
#define MDS_ImageFunctional_H
...
public:
    ...
    void operator ()(T& Value)
    {
        ...
        m_Previous = Value;
        Value = mds::img::CPixelTraits<T>::getZero();
