 ...
 * Date:    2004/04/19                          \n
 *
 * $Id: mdsKernel.h 2092 2012-02-15 12:50:59Z spanel $
 * 
 * Description:
 ...
 */
class MDS_IMAGE_EXPORT CKernel1D : private mds::base::CData<tConvKernelData>
{
public:
    //! Kernel data.
 ...
 */
class MDS_IMAGE_EXPORT CKernel2D : private mds::base::CData<tConvKernelData>
{
public:
    //! Data base.
    typedef mds::base::CData<tConvKernelData> data;
 ...
 */
class MDS_IMAGE_EXPORT CKernel3D : private mds::base::CData<tConvKernelData>
{
public:
    //! Data base.
    typedef mds::base::CData<tConvKernelData> data;
