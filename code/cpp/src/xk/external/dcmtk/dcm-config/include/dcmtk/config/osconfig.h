...
#define DCMTK_PREFIX "/media/mint/MainVolume/newmint/dcmtk-install"
...
#define DCM_DICT_DEFAULT_PATH "/media/mint/MainVolume/newmint/dcmtk-install/share/dcmtk/dicom.dic"

/* Define the default directory where configuration files reside. */
#define DEFAULT_CONFIGURATION_DIR "/media/mint/MainVolume/newmint/dcmtk-install/etc/dcmtk/"

/* Define the default directory where support data files reside. */
#define DEFAULT_SUPPORT_DATA_DIR "/media/mint/MainVolume/newmint/dcmtk-install/share/dcmtk/"
...
#define PACKAGE_STRING "dcmtk 3.6.5"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "dcmtk-3.6.5"
