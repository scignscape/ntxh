 ...
 * 
 * <b>Time:</b><br>
 * (i) time(u4 x, time_unit unit) - for exact time. Eg: \p time(3, MINS) for "3 mins".<br>
 * (ii) time_range(u4 x, u4 y, time_unit unit) - for a time range. Eg. \p time_range(3, 5, MINS) for "3 - 5 mins".<br>
 * (iii) min_time(u4 x, time_unit unit) - for the minimum time. Eg. \p min_time(3, MINS) for "at least 3 mins".<br>
 * (iv) max_time(u4 x, time_unit unit) - for the maximum time. Eg. \p max_time(3, MINS) for "at most 3 mins".<br>
 * (v) approx_time(u4 x, time_unit unit) - for approximate time. Eg. \p approx_time(3, MINS) for "~3 mins".<br>
...
{
 STERILE_MICROFUGE_TUBE /*!< Sterile 1.5-ml microfuge tube */, 
 CENTRIFUGE_TUBE_15ML/*!< 15ml centrifuge tube */, 
 FLASK/*!< Flask */, 
 CENTRIFUGE_BOTTLE/*!< Centrifuge bottle */, 
 GRADUATED_CYLINDER/*!< Graduated cylinder */, 
 HUMIDIFIED_CHAMBER/*!< container that can be placed in a humidified chamber */, 
 RXN_TUBE/*!< Reaction tube */, 
 FRESH_COLL_TUBE/*!< Fresh collection tube */, 
 LIQUID_NITROGEN/*!< container with liquid nitrogen */, 
 PLG/*!< 50ml PLG tube */, 
 OAKRIDGE/*!< Oakridge tube */, 
 QIA_CARTRIDGE/*!< Qiacartridge */, 
 CUVETTE_ICE/*!< Cuvette stored on ice */, 
 SPEC_CUVETTE/*!< spectrometry cuvette */, 
 STOCK_PLATE_96/*!< 96-well stock plate */, 
 WELL_BLOCK_96/*!< 96-well block */, 
 PCR_PLATE/*!< 96-well PCR plate */, 
 LIQUID_BLOCK/*!< 96-well liquid block */, 
 CELL_CULT_CHAMBER/*!< Cell culture chamber */, 
 EPPENDORF/*!< Eppendorf tube */, 
 STERILE_MICROFUGE_TUBE2ML/*!< Sterile 2 ml microcentrifuge tube */, 
 STERILE_PCR_TUBE/*!< Sterile 0.6-ml tube */, 
 CENTRI_TUBE_50ML/*!< 50-ml centrifuge tube */, 
 CRYO_VIAL/*!< screw-topped cryo vial */, 
 SCREW_CAP_TUBE/*!< Screw-cap tube of appropriate volume */
};

/*!Specifies whether drying has to be performed in air or in vacuum. */
enum class drying{IN_AIR, IN_VACUUM};
/// @cond
/*! Used internally for conversion between volume units. */
enum class factor{MICRO=1/*!< Conversion value = 1 */, 
 MILLI=1000/*!< Conversion value = 1000 */, 
 LITRE=1000000/*!< Conversion value = 1000000 */
};
/*! Specifies the type of the subtance. Used internally. */
enum class fluid_type {FLUID, SOLID, CONTAINER, OPERATION} ;
/// @endcond
...
enum class func
{
 ...
 ENZYME_INAC/*!< enzyme inactivation */
};
/*! Types of mixing. For use in incubate_and_mix(). */
enum class mixing {TAPPING, STIRRING, INVERTING, VORTEXING, RESUSPENDING, DISSOLVING, PIPETTING};
/*! Specifies the type of PCR being performed. For use in thermocycler(). */ 
enum class pcr_type{NORMAL/*!< Regular PCR */, 
 GRADIENT/*!< Gradient PCR */, 
 COLONY/*!< Colony PCR */
};
/*! Specifies the unit of the speed of the rotor in a centrifuge instruction. */
enum class speed_type{RPM, G};
/*! Specifies the type of time constrau4 being employed. For use in time_constraint(). */
enum class time_constraint_type{CURRENT_FLUID/*!< if \c time_constraint() is applicable to the subsequent use of the contents of a particular container. */, 
 NEXTSTEP/*!< if \c time_constraint() is applicable between a pair of successive steps that use the contents of a container. */
};
/*! Time units supported. */
enum class time_unit{SECS/*!< seconds */, 
 MINS/*!< minutes */, 
 HRS/*!< hours */
};
...
enum class until{ETHANOL_EVAP/*!< "until all the ethanol has evaporated and no fluid is visible in the tube".*/, 
 OD/*!< "until the O.D.600 reaches 0.6". */, 
 THAW/*!< "until the sample has thawed". */, 
 COOLED/*!< "until cooled". */, 
 COLOUR_DEVELOPS/*!< "until the colour develops". */, 
 PPT_STOPS_STICKING/*!< "until the precipitate stops sticking to the walls of the tube". */, 
 PELLET_DISLODGES/*!< "until the pellet dislodges". */, 
 THAW_ICE/*!< "keep on ice until the sample has thawed" */
};

/*! Volume units supported. */
enum class vol_unit{UL/*!< microliter */, 
 ML/*!< milliliter */, 
 L/*!< liter */
};

/*! Types of washing. For use in wash_slide(). */
enum class wash_type
{
 WASHING, RINSING
};
...
struct Fluid
{
 ...
 QString original_name;/*!< The name of the fluid. */
  // *!< The name of the fluid after renaming. Initially, original_name = new_name */
 QString new_name;

 //enum 
 container_type container; /*!< The container of the fluid. */
 QString state; /*!< The state of the fluid. */
 r4 volume; /*!< The volume of the fluid. */
 //enum 
 vol_unit unit; /*!< The unit of volume. */
 fluid_type type; /*!< The type of this resource. */
 u4 used; /*!< Used internally to track the usage of the fluid. */
 u4 usage_index; /*!< Used internally to track the usage of the fluid. */
...
struct Container
{
 Node* node; /*!< The current graph node. */
 //enum 
 container_type id; /*!< The container's id. */
 Fluid contents; /*!< The contents of the container. */
 r4 volume; 
  /*!< The volume of the contents of the container. Note: This is different from the content's volume i. e. container.volume != container.contents.volume */
 QString name; /*!< The container's label. */
 fluid_type type; /*!< The type of this resource. */
 u4 used; /*!< Used internally to track the usage of the container. */
 u4 usage_index; /*!< Used internally to track the usage of the container. */
...
typedef Fluid Solid; // Defines a solid.
typedef Container Column; // Defines a column.
typedef Solid Plate; // Defines a plate.
typedef Container Slide; // Defines a slide.
typedef Solid Tissue; // Defines a tissue.
...
{
public:
 Minimum_time(r4 x, time_unit unit);
 void display_time();
 ~Minimum_time(){}
};
...
{
public:
 Maximum_time(r4 x, time_unit unit);
 void display_time();
 ~Maximum_time(){}
}; 
...
{
public:
 Approx_time(r4 x, time_unit unit);
 void display_time();
 ~Approx_time(){}
};
...
public:
 r4 value1;
 Time_range(r4 x, r4 y, time_unit unit);
 void display_time();
 ~Time_range(){}
}; 
...
{
public:
 Minimum_speed(r4 x, speed_type unit);
 void display_speed();
 ~Minimum_speed(){}
};
...
{
public:
 Maximum_speed(r4 x, speed_type unit);
 void display_speed();
 ~Maximum_speed(){}
};
...
public:
 ...
 Approx_speed(r4 x, speed_type unit);
 void display_speed();
 ~Approx_speed(){}
}; 
...
public:
 r4 value1;
 Speed_range(r4 x, r4 y, speed_type unit);
 void display_speed();
 ~Speed_range() {}
}; 
...
public:
 r4 value1;
 Volume_range(){}
 Volume_range(r4 x, r4 y, vol_unit unit);
 void display_vol();
};
...
public:
 Approx_volume(){}
 Approx_volume(r4 x, vol_unit unit);
 void display_vol();
};
...
\sa nanodrop()
*/
extern void ce_detect (Container& container1, r4 length, r4 volt_per_cm, Fluid& fluid1);
...
\sa nanodrop()
*/
extern void ce_detect (Container& container1, r4 length, r4 volt_per_cm, Fluid& fluid1, Time* time1);
...
*/
extern void cell_culture(Container& cells, Fluid& medium, u4 centri_speed, r4 temp, r4 time, r4 percent_CO2, Fluid& for_wash_valves, Fluid& for_wash_chambers, Fluid& for_trypsinization, r4 for_feeding);
...
*/
extern void centrifuge(Container &container1, Speed* speed1, r4 temp, Time* time1);
...
*/
extern void centrifuge_column(Column& column1, r4 temp, Time* time1);
...
\sa centrifuge_flow_through()
*/
extern void centrifuge_column(Column& column1, Speed* speed1, r4 temp, Time* time1);
...
*/
extern void centrifuge_flow_through(Column& column1, r4 temp, Time* time1, Container& container1);
...
\sa centrifuge_column()
*/
extern void centrifuge_flow_through(Column& column1, Speed* speed1, r4 temp, Time* time1, Container& container1);
...
*/
extern void centrifuge_pellet(Container& container1, Speed* speed1, r4 temp, Time* time1);
...
*/
extern void centrifuge_pellet(Container& container1, Speed* speed1, r4 temp, Time* time1, Volume* expected_vol);
...
*/
extern void centrifuge_phases_top(Container& container1, Speed* speed1, r4 temp, Time* time1, Container& container2);
...
\sa centrifuge_pellet() 
*/
extern void centrifuge_phases_top(Container& container1, Speed* speed1, r4 temp, Time* time1, Volume* aspirate_vol, Container& container2);
...
*/
extern void centrifuge_phases_bottom(Container& container1, Speed* speed1, r4 temp, Time* time1, Volume* aspirate_vol, Volume* leave_behind);
...
\sa homogenize_tissue()
*/
extern void collect_tissue(Tissue& sample1, r4 wt, weight_unit unit, Container& container1);
...
\sa combine_and_mix()
*/
extern void combine (u4 count, Container& container1, ...);
...
*/
extern void combine_and_mix (mixing type, u4 count, Container& container1, ...);
...
\sa combine(), tap(), stir(), invert(), vortex(), resuspend(), dissolve(), pipet() and enum mixing 
*/
extern void combine_and_mix (mixing type, Time* time1, u4 count, Container& container1, ...);
...
\sa to_do()
*/
extern void comment(QString comm);
...
\sa nanodrop()
*/
extern void electrophoresis(Container& container1, r4 agar_conc);
...
\par Output:
\htmlonly Perform 0.8% agarose gel electrophoresis of (array1[0].contents.name) and (array1[1].contents.name)(5mcL sample and 1mcL of loading buffer), mixed with ethidium bromide
and visualize with UV transilluminator to confirm the presence of required product. \endhtmlonly
\sa nanodrop()
*/
...
*/
extern void electroporate (Container& container1, r4 voltage, u4 no_pulses);
...
\sa next_option(), end_option()
*/
extern void first_option(QString name);
...
\sa next_step(), optional_step() and first_sub_step()
*/
extern void first_step(QString step_name);
...
*/
extern void immerse_slide(Slide& slide1, Fluid& sample1, u4 no_of_times);
...
\sa immerse_slide_and_incubate() 
*/
extern void immerse_slide(Slide& slide1, Fluid& sample1, Time* time1, u4 no_of_times);
...
*/
extern void immerse_slide(Slide& slide1, Fluid& sample1, Time* time1, func function, u4 no_of_times);
...
\sa immerse_slide()
*/
extern void immerse_slide_and_incubate(Slide& slide1, Fluid& sample1, r4 temp, Time* time1);
...
*/
extern void immerse_slide_and_incubate(Slide& slide1, Fluid& sample1, r4 temp, Time* time1, container_type type);
...
*/
extern void incubate(Container& container1, r4 temp, Time* time1);
...
\sa store(), store_for(), store_until() and inoculation() 
*/
extern void incubate(Container& container1, r4 temp, Time* time1, u4 rpm);
...
*/
extern void incubate_and_mix(Container& container1, r4 temp, Time* time1, Time* time_mix, mixing type);
...
*/
extern void incubate_plate(Plate& plate1, r4 temp, Time* time1);
...
*/
extern void inoculation(Container& medium, Solid& sample1, r4 temp, Time* time1, u4 shaking_type);
...
\sa incubate() and store_until() 
*/
extern void inoculation(Container& medium, Solid& sample1, r4 temp, Time* time1, r4 cell_density, u4 shaking_type);
...
\sa incubate() and store_until()
*/
extern void inoculation(Container& medium, Fluid& sample1, Volume* volume1, r4 temp, Time* time1, u4 shaking_type);
...
\sa incubate() and store_until()
*/
extern void inoculation(Container& medium, Fluid& sample1, Volume* volume1, r4 temp, Time* time1, r4 cell_density, u4 shaking_type);
...
\sa tap(), stir(), vortex(), dissolve(), resuspend(), pipet() and combine_and_mix()
*/
extern void invert(Container& container1, u4 times);
...
\sa tap(), stir(), vortex(), dissolve(), resuspend(), pipet() and combine_and_mix()
*/
extern void invert(Container& container1, u4 min_times, u4 max_times);
...
*/
extern void invert(Container& container1, until event1);
...
\sa store(), store_for(), store_until, incubate(), enum ranges and time_unit
*/
extern void invert_dry(Container& container1, r4 temp);
...
*/
extern void invert_dry(Container& container1, r4 temp, Time* time1);
...
*/
extern void measure_solid(Solid& solid1, r4 weight, weight_unit unit, Container& container1);
...
*/
extern void measure_prop(Container& dest, Fluid& source, r4 prop);
...
\sa measure_fluid and measure_fluid()
*/
extern void measure_prop(Container& dest, Container& source, r4 prop);
...
\code 
{
 ...
 QString tube[2] = {"R","E"};
 r4 volumes[2][7]={{38.5,5,0.5,4,0,1,1},{38.5,5,0.5,4,1,0,1}};
...
\sa mixing_table_pcr()
*/
extern void mixing_table(u4 no_rows, u4 no_columns, Volume* rxn_vol, Fluid array1[], QString tube[], r4 *vol, Container& container1);
...
\code
{
 ...
 QString tubes[1] = {"Restriction Digest - PCR product"};
...
\sa mixing_table_pcr()
*/
extern void mixing_table(u4 no_rows, u4 no_columns, Fluid array1[], QString tube[], Volume* vol[], Volume* rxn_vol, Container& container1);
...
\code
{
 ...
 QString (initial_conc)[5]={"--","20 U ul<sup>-1</sup>","10X","10 mg ml<sup>-1</sup>","--"};
 QString (final_conc)[5]={"2 ug","40 U","1X","0.33 ug ul<sup>-1</sup>","--"};
...
\sa mixing_table()
*/
extern void mixing_table_pcr(u4 no_rows, Volume* rxn_vol, Fluid array1[], char*initial_conc[], QString final_conc[], Volume* vol[], Container& container1);
...
*/
extern void mount_observe_slide(Slide& slide1, Fluid& sample1, QString device);
...
*/
extern void name_column(Column& column1, QString new_name);
...
\sa name_sample()
*/
extern void name_container(Container& container1, QString name);
...
*/
extern void name_plate(Plate& plate1, QString new_name);
...
\sa name_container()
*/
extern void name_sample(Container& container1, QString new_name);
...
*/
extern Container new_container(container_type cont_id);
...
\sa enum container_type, new_fluid(), new_solid() and new_plate()
*/
extern Container new_container(container_type cont_id, Fluid& fluid1);
...
*/
extern Fluid new_fluid(QString name);
...
\sa new_solid(), new_container() and new_plate()
*/
extern Fluid new_fluid(QString name, Volume* volume1);
...
\sa new_solid(), new_container() and new_plate()
*/
extern  Fluid new_fluid(char*name, r4 temp);
...
\sa new_solid(), new_container() and new_plate()
*/
extern  Fluid new_fluid(char*name, r4 temp, Volume* volume1);
...
\sa new_solid(), new_container() and new_plate()
*/
extern  Fluid new_fluid(char*name, QString state);
...
\sa new_solid(), new_container() and new_plate()
*/
extern  Fluid new_fluid(char*name, QString state, Volume* volume1);
...
\sa new_solid(), new_container() and new_plate()
*/
extern  Fluid new_fluid (QString name, char*state, r4 temp);
...
\sa new_solid(), new_container() and new_plate()
*/
extern  Fluid new_fluid (QString name, char*state, r4 temp, Volume* volume1);
...
*/
extern Symbol new_symbol(QString symbol, QString def);
...
\sa new_fluid(), new_solid(), new_plate() and new_container()
*/
extern Symbol_t new_symbol_t(QString symbol, QString def);
...
\sa new_fluid(), new_solid() and new_container()
*/
extern Plate new_plate(char*name, QString state);
...
\sa new_fluid(), new_solid(), new_plate() and new_container()
*/
extern Slide new_slide(QString name);
...
*/
extern Solid new_solid(QString name);
...
\sa new_fluid(), new_container() and new_plate()
*/
extern  Solid new_solid(char*name, r4 temp);
...
\sa new_fluid(), new_container() and new_plate()
*/
extern  Solid new_solid(char*name, QString state);
...
\sa new_fluid(), new_container() and new_plate()
*/
extern  Solid new_solid (QString name, char*state, r4 temp);
...
\sa first_option(), end_option()
*/
extern void next_option(QString name);
...
\sa first_step(), optional_step() and next_sub_step()
*/
extern void next_step(QString step_name);
...
\sa first_step(), next_step(), first_sub_step() and next_sub_step()
*/
extern void optional_step(QString name);
...
*/
extern void pcr_final_ext(Container& container1, r4 temp_ext, Time* time_ext, r4 temp_hold);
...
\sa pcr_initial_denat() and thermocycler()
*/
extern void pcr_final_ext(Container& container1, r4 temp_ext, Time* time_ext, r4 temp_halt, Time* time_halt, r4 temp_hold);
...
*/
extern void pcr_init_denat(Container& container1, r4 temp, Time* time1);
...
\sa new_container(), enum container_type
*/
extern void set_value(Symbol& symbol1, r4 value, vol_unit unit);
...
\sa new_container(), enum container_type
*/
extern void set_value(Symbol_t& symbol1, r4 value, time_unit unit);
...
\par Output:
\htmlonly Dilute to <font color=#357EC7>100ng/mcL</font> and send <font color=#357EC7>1mcG (10mcL)</font> for sequencing. \endhtmlonly
...
*/
extern void set_temp(Container& container1, r4 temp);
...
\sa end_protocol()
*/
extern void start_protocol(QString name);
...
*/
extern void store(Container& container1, r4 temp);
...
*/
extern void store_for(Container& container1, r4 temp, Time* time1);
...
\sa store(), store_until() and incubate()
*/
extern void store_for(Container& container1, r4 temp, Time* time1, func function);
...
\sa store(), store_for(), store_until() and incubate()
*/
extern void store_plate(Plate& plate1, r4 temp);
...
\sa store(), store_for(), incubate(), and time_unit
*/
extern void store_until(Container& container1, r4 temp, enum until type);
...
*/
extern void store_until(Container& container1, r4 temp, until type, Time* time1);
...
*/
extern void tap (Container& container1, until event1);
...
\sa enum pcr_type 
*/
extern void thermocycler (Plate& plate1, pcr_type type);
...
*/
extern void thermocycler(Container& container1, r4 temp1, Time* time1);
...
\sa pcr_init_denat(), pcr_final_ext and thermocycler_anneal()
*/
extern void thermocycler (Container& master_mix, u4 cycles, r4 temp1, Time* time1, r4 temp2, Time* time2);
...
\sa pcr_init_denat(), pcr_final_ext() and thermocycler_anneal()
*/
extern void thermocycler (Container& master_mix, r4 temp1, Time* time1, r4 temp2, Time* time2);
...
*/
extern void thermocycler (Container& master_mix, u4 cycles, r4 temp1, Time* time1, r4 temp2, Time* time2, r4 temp3, Time* time3, enum pcr_type type);
...
\sa pcr_init_denat(), pcr_final_ext(), thermocycler_anneal() and enum pcr_type
*/
extern void thermocycler (Container& master_mix, u4 cycles, r4 temp1, Time* time1, r4 temp2, Time* time2, r4 temp3, Time* time3, enum pcr_type type, r4 grad_temp);
...
*/
extern void thermocycler_anneal(Container& container1, r4 cool_to_temp, r4 gradient, Time* time1);
...
\sa comment()
*/
extern void to_do(QString clarify);
...
\sa time_constraint()
*/
extern void use_or_store(Container& container1, Time* time1, r4 temp_use, r4 temp_store);
...
\sa enum wash_type 
*/
extern void wash_slide(Slide& slide1, Fluid& sample1, wash_type type, Time* time1, u4 no_of_times);
...
\sa enum wash_type
*/
extern void wash_tissue(Tissue& tissue1, Fluid& sample1, enum wash_type type, r4 temp, u4 shaking);
...
\sa enum wash_type 
*/
extern void wash_tissue(Tissue& tissue1, Fluid& sample1, enum wash_type type, Time* time1, u4 no_of_times, r4 temp, u4 shaking);
