...
#ifndef QIMPLCONSOLE_H
#define QIMPLCONSOLE_H
...
class QImplConsole : public QConsole
{
public:
    //destructor
    ~QImplConsole();

    //get the QImplConsole instance
    static QImplConsole* getInstance(QWidget *parent = NULL,
...
protected:
    ...
    //private constructor
    QImplConsole(QWidget *parent = NULL,
               const QString& welcomeText = "");
...
private:
    ...
    //The instance
    static QImplConsole* theInstance;
