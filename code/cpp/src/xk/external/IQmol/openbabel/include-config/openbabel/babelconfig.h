...
#define BABEL_DATADIR "/media/mint/MainVolume/IQmol/openbabel-install/share/openbabel"
...
#define OB_MODULE_PATH "/media/mint/MainVolume/IQmol/openbabel-install/lib/openbabel/2.3.2"
