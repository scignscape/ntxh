...
public:
    ...
    void setupUi(QWidget *EomTab)
    {
        if (EomTab->objectName().isEmpty())
            EomTab->setObjectName(QStringLiteral("EomTab"));
        ...
        label_eom1->setObjectName(QStringLiteral("label_eom1"));

        gridLayout_7->addWidget(label_eom1, 0, 0, 1, 1);

        qui_eom_states1 = new QLineEdit(EomTab);
        qui_eom_states1->setObjectName(QStringLiteral("qui_eom_states1"));
    ...
    {
        EomTab->setWindowTitle(QApplication::translate("EomTab", "Form", Q_NULLPTR));
        qui_eom_ee->setText(QApplication::translate("EomTab", "EE", Q_NULLPTR));
        qui_eom_sf->setText(QApplication::translate("EomTab", "SF", Q_NULLPTR));
        qui_eom_ip->setText(QApplication::translate("EomTab", "IP", Q_NULLPTR));
        qui_eom_ea->setText(QApplication::translate("EomTab", "EA", Q_NULLPTR));
        qui_eom_dip->setText(QApplication::translate("EomTab", "DIP", Q_NULLPTR));
        label_eom1->setText(QApplication::translate("EomTab", "Singlets", Q_NULLPTR));
        label_eom2->setText(QApplication::translate("EomTab", "Triplets", Q_NULLPTR));
        cc_eom_properties->setText(QApplication::translate("EomTab", "Excited State Properties", Q_NULLPTR));
        cc_eom_transition_properties->setText(QApplication::translate("EomTab", "Transition Properties", Q_NULLPTR));
        eom_ref_prop_te->setText(QApplication::translate("EomTab", "2 Electron Transition Properties", Q_NULLPTR));
        label_cc_state_to_opt->setText(QApplication::translate("EomTab", "State to optimize", Q_NULLPTR));
    } // retranslateUi
