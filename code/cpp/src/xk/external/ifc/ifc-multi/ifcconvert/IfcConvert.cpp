...
#if defined(_MSC_VER) && defined(_UNICODE)
int ifc_convert_run_main(int argc, wchar_t** argv, QApplication* qapp);

int ifc_convert_run_main(QApplication* qapp = nullptr)
{
 return ifc_convert_run_main(0, nullptr, qapp);
}

int ifc_convert_run_main(int argc, wchar_t** argv)
{
...
int ifc_convert_run_main(int argc, char** argv, QApplication* qapp);
int ifc_convert_run_main(QApplication* qapp = nullptr)
{
 return ifc_convert_run_main(0, nullptr, qapp);
}

int ifc_convert_run_main(int argc, char** argv, QApplication* qapp = nullptr)
{
 ...
 const path_t input_filename =
   dialog_input_file.isEmpty()? vmap["input-file"].as<path_t>()
   :  dialog_input_file.toStdString();
