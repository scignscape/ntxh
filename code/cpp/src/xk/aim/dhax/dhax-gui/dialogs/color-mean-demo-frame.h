...
#ifndef COLOR_MEAN_DEMO_FRAME__H
#define COLOR_MEAN_DEMO_FRAME__H
...
class Color_Mean_Demo_Frame : public QFrame
{
 Q_OBJECT
...
// QLabel* color_mean_label_;
// QLabel* tierboxes_label_;


 u4 image_width_;
 u4 large_image_width_;

 u4 image_height_;
 u4 large_image_height_;


public:

 Color_Mean_Demo_Frame(QVector<QStringList> paths,
   u4 image_width, u4 large_image_width,
   u4 scroll_minimum_width,
   u4 image_height = 0, u4 large_image_height = 0);

 static QPushButton* image_path_as_qbutton(QWidget* parent, QString path, u4 image_width, u4 image_height);
 static QLabel* image_path_as_qlabel(QWidget* parent, QString path, u4 image_width, u4 image_height);
