...
//? setWindowTitle("Xpdf");
 ...
 QString folder = DEFAULT_ICONS_FOLDER;// DEFAULT_PDF_FILE;
...
// qDebug() << folder;
 ...
 doc_prev.setHtml(QString("<img src='%1/larrow.jpg' width='%2'><span style='font-size:%3px'>Previous Question</span>").arg(folder).arg(w).arg(fs));
 ...
 doc_next.setHtml(QString("<img src='%1/rarrow.png' width='%2'><span style='font-size:%3px'>Next Question</span>").arg(folder).arg(w).arg(fs)); //.arg(pb));
