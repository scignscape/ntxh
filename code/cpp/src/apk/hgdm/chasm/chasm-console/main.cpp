...
u2 testqs2(QString arg1, u4 arg2, u1 arg3)
{
 ...
 qDebug() << "arg2 = " << arg2;
 qDebug() << "arg3 = " << arg3;
 u2 result = 10 * (arg1.size() + arg2 + arg3);
 return result;
}
...
// ccp->add_carrier(cc0);
// csr->evaluate(ccp, 71341, (minimal_fn_s0_r1_type) &testqs1, &cc0);

// u1 result = cc0.raw_value<u1>();
// qDebug() << "r = " << result;

 Chasm_Carrier cc0 = csr->gen_carrier<u2>(csr->Result._u2);
 ccp->add_carrier(cc0);
 csr->evaluate(ccp, 72341, (minimal_fn_s0_r1_type) &testqs2, &cc0);

 u2 result = cc0.raw_value<u2>();
 qDebug() << "r = " << result;
