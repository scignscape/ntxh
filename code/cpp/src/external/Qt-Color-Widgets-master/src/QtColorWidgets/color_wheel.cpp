...
void ColorWheel::paintEvent(QPaintEvent * )
{
   ...
   // p->draw_ring_editor(p->hue, painter, Qt::blue);
    ...
    {
     inner_white = p->val <= 0.5;
        painter.setPen(QPen(p->val > 0.5 ? Qt::black : Qt::white, 2));
    }
    painter.setBrush(Qt::NoBrush);

    painter.drawArc(selector_position.x() - 6, selector_position.y() - 6, 12, 12, 210*16, 180*16);
    painter.drawArc(selector_position.x() - 8, selector_position.y() - 8, 16, 16, 30*16, 180*16);

//    painter.drawEllipse(selector_position, selector_radius + 1, selector_radius + 1);

    painter.setPen(QPen(inner_white? Qt::black : Qt::white, 2));

    painter.drawArc(selector_position.x() - 6, selector_position.y() - 6, 12, 12, 30*16, 180*16);
    painter.drawArc(selector_position.x() - 8, selector_position.y() - 8, 16, 16, 210*16, 180*16);

//    painter.drawEllipse(selector_position, selector_radius-2, selector_radius-2);
