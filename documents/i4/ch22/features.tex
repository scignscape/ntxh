...
\begin{figure*}[h!]%
 \centering
 \subfloat[BRISK]{\includegraphics[width=\textwidth/2]{images/BRISK.jpg}\label{fig:a}}\hspace*{3em}%
 \subfloat[SURF]{\includegraphics[width=\textwidth/2]{images/SURF.jpg}\label{fig:b}}\\
 \subfloat[BRISK overlaid on Superpixel]{\includegraphics[width=\textwidth/2]{images/superpixel.jpg}\label{fig:c}}\hspace*{3em}%
 \subfloat[Colormap Channel-Reduction]{\includegraphics[width=\textwidth/2]{images/eight.jpg}\label{fig:d}}\\%
...
detected by extending the feature point-coloud to 
