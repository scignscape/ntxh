...
those which language seeks to describe or takes as presupposed context.\;{\sssg}\footnote{For example, \cite[pp. 119 and 128]{LangackerFoundations},
discussed by \cite[p. 189]{LineBrandt}, and \cite[p. 9]{EstherPascual}.
}
{\srsg}\+In particular, Langacker argues that \q{students} and \q{question} can both be either singular or
...
\+Here (\ref{itm:threes}) is a more direct translation of the facts
...
less on speaker's contextual understanding to fill in detail.\;{\sssg}\footnote{The examples I have used so far may also imply that a choice of phrase structure is
...
\udref{en_ewt-ud-train}{weblog-blogspot.com\_rigorousintuition\_20060511134300\_ENG\_20060511\_134300-0112}
...
\udref{en_ewt-ud-train}{newsgroup-groups.google.com\_FOOLED\_7554c5ce34a5a49e\_ENG\_20051012\_144800-0020}
...
\udref{en_gum-ud-train}{GUM_news\_warhol-35}
\end{sentenceList}
