...
\p{\:\+Moreover \q{weighs}, too, as a verb, can be given a typed-process
...
vary across computing environments.\;{\sssg}\footnote{Moreover, expectations in a particular case
...
{\srsg}\+These are some reasons why in theoretical
...
\i{typical} example: a sample letter or model home is actually not (in
...
prototypes (\cite[p. 18]{LakoffJohnson} \cite[p. 171, or p. xi] Johnson)
...
concepts themselves.\;{\sssg}\footnote{There is a type-theoretic correspondence between intension and
...
heard to dislike hand-gliding or jumping off mountains.\;{\sssg}\footnote{People, unlike birds, do not fly \mdash{} so the verb, used intransitively
...
to \i{burning} a cake (accidentally overcooking it).\;{\sssg}\footnote{We can express
...
{\srsg}\+These variations are not random assortments of polysemous words' senses:
