...
two, as if people expressed themselves like this:\;{\sssg}\<\begin{sentenceList}
...
wish was \i{expressed} via a \i{close the window}.\;{\sssg}\footnote{Consider also the case of (\i{Handbook}, example 9,
page 132, chapter 6):
...
(\ref{itm:ants})-(\ref{itm:princess})):\;{\sssg}\<\begin{sentenceList}
