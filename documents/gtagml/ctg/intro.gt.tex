...
development. \> On the one hand, transform-pairs can sometimes
be mapped explicitly to dependency or link-grammar pairs,
so the theory can be treated as a philosophical preliminary
or motivation for Dependency or Link Grammar.\;{\sssg}\footnote{Dependency and Link Grammar both build syntactic structures
